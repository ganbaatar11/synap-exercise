...
ActiveRecord::Schema.define(version: 20180217031246) do
  ...
  add_index "event_league_joins", ["event_id"], name: "index_event_league_joins_on_event_id", using: :btree
  add_index "event_league_joins", ["league_id"], name: "index_event_league_joins_on_league_id", using: :btree
